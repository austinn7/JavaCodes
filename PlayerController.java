...
public class PlayerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        visualizers.add(new Amnd7dMyVisualizerS21());
        visualizers.add(new Amnd7dCircleVisualizerS21());
    ...
    private void handleReady() {
        ...
        String format = timeFormat.format(ms);
        lengthText.setText(format + "s");
        Duration ct = mediaPlayer.getCurrentTime();
        currentText.setText(ct.toString() + "s");
        currentVisualizer.setup(numOfBands, vizPane);
        timeSlider.setMin(0);
    ...
    private void handleEndOfMedia() {
        ...
        volumeText.setText(Math.round(volumeSlider.getValue() * 100) + "%");
    }
    ...
    private void handleVisualize(double timestamp, double duration, float[] magnitudes, float[] phases) {
        ...
        String format = formatter.format(ms);
        currentText.setText(String.format(format + "s"));
    ...
    @FXML
    private void handleTimeSliderMouseDragged(MouseEvent event) {
        if(mediaPlayer != null){
            SimpleDateFormat formatter= new SimpleDateFormat("mm:ss");
            String format = formatter.format(timeSlider.getValue());
